              ...
              {appliances.length === 0 ? (
                ...
                <div className="mt-3 space-y-2">
                  ...
                  {appliances.map((a) => (
                    <div
                      key={a.key}
                      className="grid grid-cols-2 sm:grid-cols-[1.4fr_0.7fr_0.9fr_0.9fr_auto] gap-3 items-center rounded-md bg-navy-900/5 px-3 py-2.5"
                    >
                      ...
                      <input
                        ...
                        className="w-full rounded border border-ink/15 bg-white px-2 py-1.5 text-sm tabular-nums"
                      />
                      ...
                      <button
                        ...
                        className="justify-self-end text-ink/35 hover:text-destructive transition-colors p-1"
                      >
                        <Trash2 size={16} />
                      </button>
                    </div>
...
function ResultRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-baseline justify-between gap-4 border-b border-navy-700 pb-3">
      ...
      <span className="font-mono text-base text-gold tabular-nums whitespace-nowrap">{value}</span>
    </div>
  )
}
