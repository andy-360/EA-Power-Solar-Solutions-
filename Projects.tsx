          ...
          {PROJECTS.map((p) => (
            <div key={p.id} className="rounded-lg border border-ink/10 overflow-hidden">
              <div className="h-32 bg-navy-800 relative">
                <div className="absolute inset-0 opacity-40" style={GRID_PATTERN} />
...
const GRID_PATTERN: CSSProperties = {
  backgroundImage:
    'linear-gradient(#5B93BC 1px, transparent 1px), linear-gradient(90deg, #5B93BC 1px, transparent 1px)',
